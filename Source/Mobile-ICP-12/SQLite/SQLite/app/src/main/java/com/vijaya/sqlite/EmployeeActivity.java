...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void updateTheDB() {
        ...
        ContentValues values = new ContentValues();
        values.put(SampleDBContract.Employee.COLUMN_JOB_DESCRIPTION,
                binding.jobDescEditText.getText().toString());
        values.put(SampleDBContract.Employee.COLUMN_EMPLOYER_ID,
                ((Cursor) binding.employerSpinner.getSelectedItem()).getInt(0));
        database.update(SampleDBContract.Employee.TABLE_NAME, values, "_id="+id,
                null);
        Toast.makeText(this, "Selected item updated", Toast.LENGTH_LONG).show();
    }
    ...
    private void deleteFromDB() {
        ...
        Toast.makeText(this, "Selected item deleted", Toast.LENGTH_LONG).show();
